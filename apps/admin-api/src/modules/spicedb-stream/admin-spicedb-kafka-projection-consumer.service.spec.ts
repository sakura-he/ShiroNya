        ...
        ({
            get: jest.fn((key: string, defaultValue?: string) => {
                const values: Record<string, string> = {
                    ADMIN_SPICEDB_KAFKA_ENABLED: String(enabled),
                    ADMIN_SPICEDB_KAFKA_WATCH_EVENTS_TOPIC: 'events-topic',
                    ADMIN_SPICEDB_KAFKA_WATCH_DLQ_TOPIC: 'dlq-topic',
                    ADMIN_SPICEDB_KAFKA_PROJECTION_CONSUMER_GROUP: 'consumer-group',
                    ADMIN_SPICEDB_KAFKA_PROJECTION_CONSUMER_MAX_FAILURES: '5'
                };
