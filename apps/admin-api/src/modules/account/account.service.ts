...
import { ACCOUNT_NAVIGATION_CACHE_TTL_SECONDS, createAdminAccountNavigationRedisKey } from '@app/common/constants';
...
import { MenuStatusEnum, MenuTypeEnum, RbacMenu, RbacStatus } from '@app/prisma-admin/generated/client';
...
export class AccountService {
    ...
    private createAccountNavigationCacheKey(userId: string, userStateVersion: string): string {
        return createAdminAccountNavigationRedisKey(userId, userStateVersion);
    }
