...
import { ADMIN_AUTHZ_PROJECTION_CACHE_VERSION_REDIS_KEY } from '@app/common/constants';
...
export const AUTHZ_PROJECTION_CACHE_VERSION_KEY = ADMIN_AUTHZ_PROJECTION_CACHE_VERSION_REDIS_KEY;
