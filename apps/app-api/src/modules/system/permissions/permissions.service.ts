...
import { Prisma, RbacPermission, RbacStatus } from '@app/prisma-app/generated/client';
...
export class SystemRbacPermissionsService {
    ...
    async getPermissionList(query: QueryRbacPermissionListDto, actorId: string, context?: RbacServiceContext) {
        await assertRbacServicePermission(this.authzService, actorId, RBAC_PERMISSIONS.PERMISSION_VIEW, context);
        ...
        const meta = await this.getMeta(actorId, context);
    ...
    async createPermission(data: CreateRbacPermissionDto, actorId: string, context?: RbacServiceContext) {
        await assertRbacServicePermission(this.authzService, actorId, RBAC_PERMISSIONS.PERMISSION_CREATE, context);
    ...
    async getDeclarationBoard(actorId: string, context?: RbacServiceContext) {
        await assertRbacServicePermission(this.authzService, actorId, RBAC_PERMISSIONS.PERMISSION_VIEW, context);
    ...
    async updatePermission(id: number, data: UpdateRbacPermissionDto, actorId: string, context?: RbacServiceContext) {
        await assertRbacServicePermission(this.authzService, actorId, RBAC_PERMISSIONS.PERMISSION_UPDATE, context);
    ...
    async deletePermission(id: number, actorId: string, context?: RbacServiceContext) {
        await assertRbacServicePermission(this.authzService, actorId, RBAC_PERMISSIONS.PERMISSION_DELETE, context);
        const permission = await this.getExistingPermission(id);
    ...
    async suggestCode(data: SuggestRbacPermissionCodeDto, actorId: string, context?: RbacServiceContext) {
        await assertRbacServicePermission(this.authzService, actorId, RBAC_PERMISSIONS.PERMISSION_CREATE, context);
        return {
    ...
    async getPermissionRelations(id: number, actorId: string, context?: RbacServiceContext) {
        await assertRbacServicePermission(this.authzService, actorId, RBAC_PERMISSIONS.PERMISSION_VIEW, context);
        const permission = await this.getExistingPermission(id);
        ...
        return {
            permission: await this.attachCapability(permission, actorId, context),
    ...
    async queryAssignableRoles(query: QueryRbacPermissionRolesDto, actorId: string, context?: RbacServiceContext) {
        await this.assertPermissionViewable(query.permissionId, actorId, context);
    ...
    async assignRoles(permissionId: number, roleIds: number[], actorId: string, context?: RbacServiceContext) {
        return await this.assignmentService.replacePermissionRoles(permissionId, roleIds, actorId, context);
    }
    ...
    private async assertPermissionViewable(id: number, actorId: string, context?: RbacServiceContext) {
        await assertRbacServicePermission(this.authzService, actorId, RBAC_PERMISSIONS.PERMISSION_VIEW, context);
    ...
    private async getMeta(actorId: string, context?: RbacServiceContext) {
    ...
    private async attachCapability(record: RbacPermission, actorId: string, context?: RbacServiceContext) {
        return this.withCapabilities(record, await this.getMeta(actorId, context));
    }
