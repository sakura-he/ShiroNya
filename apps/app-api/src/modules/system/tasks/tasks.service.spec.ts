...
import { Task, TaskLogStatus, TaskStatus, TaskStrategy } from '@app/prisma-app/generated/client';
...
describe('SystemTasksService', () => {
    ...
    it('查询任务列表时应返回当前页任务按钮能力和任务管理资源创建能力', async () => {
        ...
        expect(mockProjectionAuthzReadService.checkTaskManagerPermissionFromReadModel).toHaveBeenCalledWith('create', 'actor-1');
    });
