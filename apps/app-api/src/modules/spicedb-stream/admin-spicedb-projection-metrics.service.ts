...
export class AdminSpiceDbProjectionMetricsService {
     ...
     */
    constructor(
        @InjectMetric('app_api_spicedb_projection_events_total')
        private readonly projectionEventsTotal: Counter<string>,
        @InjectMetric('app_api_spicedb_projection_consumer_lag')
        private readonly projectionConsumerLag: Gauge<string>,
        @InjectMetric('app_api_spicedb_projection_last_event_age_seconds')
        private readonly lastConsumedEventAgeSeconds: Gauge<string>,
        @InjectMetric('app_api_spicedb_projection_last_zed_token_age_seconds')
        private readonly lastZedTokenAgeSeconds: Gauge<string>,
        @InjectMetric('app_api_spicedb_projection_drift_rows')
        private readonly driftRows: Gauge<string>,
        @InjectMetric('app_api_spicedb_projection_reconcile_duration_seconds')
        private readonly reconcileDurationSeconds: Histogram<string>,
        @InjectMetric('app_api_spicedb_projection_reconcile_total')
        private readonly reconcileStatusTotal: Counter<string>,
        @InjectMetric('app_api_spicedb_check_duration_seconds')
        private readonly checkDurationSeconds: Histogram<string>,
        @InjectMetric('app_api_spicedb_upstream_errors_total')
        private readonly upstreamErrorsTotal: Counter<string>,
        @InjectMetric('app_api_spicedb_connection_health')
